...
```console
charmcraft login --export /tmp/charmcreds.auth --charm ubuntu-debuginfod --permission=package-view --permission=package-manage-releases --permission=package-manage-revisions --channel=edge --ttl $((10 * 365 * 24 * 60 * 60))
```
